...
describe('Test line results translation', () => {
	...
	['then continue', 'then fail', 'then exit', 'then warn'].forEach((then) => {
		describe('Translate assert lines with ' + then, () => {
			...
			const assertLine = testLinesExamples[('Assert ... ' + then) as 'Assert ... then continue'];
