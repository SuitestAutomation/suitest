...
const translateScrollTestLine = (
	...
	const title = <fragment>Scroll from {translateTarget(testLine.target)}{titleFragment} to {direction} by {distance}px</fragment>;
	const status = testLine.excluded ? 'excluded' : lineResult?.result;
...
const translateSwipeTestLine = (
	...
	const title = <fragment>Swipe/Flick from {translateTarget(testLine.target)}{titleFragment} to {direction} by {distance}px in {duration}ms</fragment>;
	const status = testLine.excluded ? 'excluded' : lineResult?.result;
